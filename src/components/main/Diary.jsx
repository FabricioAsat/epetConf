...
const Diary = () => {
	return (
		<section id="agenda" className="max-w-6xl mx-auto">
			<Subtitle>Agenda</Subtitle>

			<div className="flex flex-col gap-y-5 px-5">
				{diary.map((talk) => (
					<div className="grid grid-cols-1 gap-y-4 md:grid-cols-4 border-2 border-gray-color/50 rounded-lg brightness-75 hover:brightness-125 py-5 md:py-0 bg-gradient-to-bl from-transparent via-transparent to-op-primary-color backdrop-blur transition-all duration-300 w-full max-w-4xl mx-auto">
						<picture className="order-2 md:order-1">
							<img src={talk.src} alt="midu" className="w-52 md:w-full h-44 mx-auto object-cover" />
						</picture>
